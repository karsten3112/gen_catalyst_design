...
def main():
    model_dir_header = "../../diffusion_model_parameters/hyperparam_search"
    ...
    script_inputs = {
        ...
        "-init_traj": os.path.join("../../diffusion_model_parameters/datasets_100", "genetic_algorithm_2000_no_saas.traj"),
