from gen_catalyst_design.post_processing import get_search_statistics, plot_kde_dist
...
def main():
    ...
    filenames_rnd_search = [f"rnd_seed_{i}_samples.db" for i in range(rnd_seeds)]
    search_method_dicts = {
        "genetic_algorithm":{"pth_header":"results", "db_filenames":filenames},
        "annealing":{"pth_header":"results", "db_filenames":filenames},
        "random_search":{"pth_header":"results", "db_filenames":filenames_rnd_search},
    }
    ...
    if plot_kde_dists:
        ...
        ax_left.legend()
    plt.savefig("result_summary_1.pdf")
