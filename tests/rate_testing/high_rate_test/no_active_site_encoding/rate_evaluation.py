...
def main():
    ...
    for noiser_type in noiser_types:
        ...
        for guidance_scale in guidance_scales:
            atoms_list = read(filename=os.path.join(pth_header, f"g_{guidance_scale}_scale.traj"), index=":")
            ...
            print(f"done evaluating for: {noiser_type} with guidance_scale: {guidance_scale}")
