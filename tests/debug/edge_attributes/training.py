...
def main():
    ...
    noiser = AbsorbingStateNoiser(element_pool=element_pool)#UniformTransitionsNoiser(element_pool=element_pool)
    ...
    diff_model = DiffusionModel(
        ...
        denoiser=denoiser,
        drop_prob=0.1,
        use_x0_reparam=False,
        auxillary_weight=0.000
    )
